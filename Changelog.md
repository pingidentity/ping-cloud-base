...
- Added support for PingAccess deployment automation, including initial deployment of a cluster, auto-scaling, 
  auto-healing of failed admin and engine instances, encrypted backup of the v1.12-release-branch key for disaster recovery upon 
...
- Organized the cluster state repo into branches for different environments instead of a single v1.12-release-branch branch with
