...
ADD_USER_LDIF_FILE="${PROJECT_DIR}"/ci-scripts/test/integration/pingdirectory/templates/add-user.ldif
DELETE_USER_LDIF_FILE="${PROJECT_DIR}"/ci-scripts/test/integration/pingdirectory/templates/delete-user.ldif
