...
#        "id": "jwt",
#        "location": "https://pingfederate-admin-68c57f7c54-fs5q4:8443/pf-admin-api/v1/oauth/accessTokenManagers/jwt"
#      },
...
#
#
#curl  -v -k -u "Administrator:2FederateM0re" -H "X-XSRF-Header: PingFederate"  -H "Accept: application/json" -H "content-type: application/json" -d "'${client}'" https://pingfederate-admin-raypf.ping-demo.com:8443/pf-admin-api/v1/oauth/clients
