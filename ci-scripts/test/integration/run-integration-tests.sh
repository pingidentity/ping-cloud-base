...
execute_test_scripts() {
  ...
  for SCRIPT in $(find ${test_directory} -print | grep -E ${regex} | sort); do
    ...
    all_tests_passed=$((${all_tests_passed} | ${test_result}))
  done
...
if test ${exit_code} -eq 0; then
  ...
  # Use printf to print in color
  printf '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n'
  printf "Prerequisite Test Summary: ${RED}Prerequisite test(s) failed under: ${TEST_DIR} ${NO_COLOR}\n"
  printf '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n'
...
if test ${exit_code} -eq 0; then
  ...
  # Use printf to print in color
  printf '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n'
  printf "Test Summary: ${RED}Integration test(s) failed under: ${TEST_DIR} ${NO_COLOR}\n"
  printf '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n'
fi
