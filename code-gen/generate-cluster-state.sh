...
#                        |                                                    |
# IDENTITY_PUB_FILE      | The file containing the public-key used by FluxCD  | No default
#                        | in PEM format. If not provided, a new key-pair     |
#                        | will be generated by the script. If provided, the  |
#                        | IDENTITY_KEY_FILE must also be provided.           |
#                        |                                                    |
# IDENTITY_KEY_FILE      | The file containing the private-key used by FluxCD | No default
#                        | in PEM format. If not provided, a new key-pair     |
#                        | will be generated by the script. If provided, the  |
#                        | IDENTITY_PUB_FILE must also be provided.           |
########################################################################################################################
...
echo "Initial IDENTITY_PUB_FILE: ${IDENTITY_PUB_FILE}"
echo "Initial IDENTITY_KEY_FILE: ${IDENTITY_KEY_FILE}"
echo ---
...
export IDENTITY_PUB_FILE="${IDENTITY_PUB_FILE}"
export IDENTITY_KEY_FILE="${IDENTITY_KEY_FILE}"
...
echo "Using IDENTITY_PUB_FILE: ${IDENTITY_PUB_FILE}"
echo "Using IDENTITY_KEY_FILE: ${IDENTITY_KEY_FILE}"
echo ---
...
if test -z "${IDENTITY_PUB_FILE}" && test -z "${IDENTITY_KEY_FILE}"; then
  echo 'Generating key-pair for fluxcd'
  generate_ssh_key_pair
elif test -z "${IDENTITY_PUB_FILE}" || test -z "${IDENTITY_KEY_FILE}"; then
  echo 'Provide fluxcd key-pair files via IDENTITY_PUB_FILE/IDENTITY_KEY_FILE env vars, or omit both for key-pair to be generated'
  exit 1
else
