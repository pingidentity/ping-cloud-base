...
#                |                                                         |
# TLS_CERT_ARN   | For PCPT, this specifies the ARN of the                 | An arbitrary valid certificate ARN (of
#                | certificate generated by ACM. This ARN will be          | the form arn:aws:acm:{region}:{user# id}:certificate/{id},
#                | set as the value of the annotation                      | so the generated configuration is still valid.
