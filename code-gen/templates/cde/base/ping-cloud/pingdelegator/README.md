...
Changing the `USER_BASE_DN_1` requires completely rolling out every PingDirectory server in the replication topology, 
...
Replace `USER_BASE_DN_1` above with the `USER_BASE_DN_1` for the customer environment.
