...
export ELASTIC_BOOTSTRAP_USER_PLAIN=${ELASTIC_BOOTSTRAP_USER_PLAIN:-elastic}
export ELASTIC_BOOTSTRAP_PASSWORD_PLAIN=${ELASTIC_BOOTSTRAP_PASSWORD_PLAIN:-2FederateM0re}
export ELASTIC_USER_PLAIN=${ELASTIC_USER_PLAIN:-elastic}
export ELASTIC_PASSWORD_PLAIN=${ELASTIC_PASSWORD_PLAIN:-2FederateM0re}
export LOGSTASH_USER_PLAIN=${LOGSTASH_USER_PLAIN:-logstash_system}
export LOGSTASH_PASSWORD_PLAIN=${LOGSTASH_PASSWORD_PLAIN:-2FederateM0re}
export KIBANA_USER_PLAIN=${KIBANA_USER_PLAIN:-kibana_system}
export KIBANA_PASSWORD_PLAIN=${KIBANA_PASSWORD_PLAIN:-2FederateM0re}


export ELASTIC_BOOTSTRAP_USER_B64=$(printf ${ELASTIC_BOOTSTRAP_USER_PLAIN} | base64)
export ELASTIC_BOOTSTRAP_PASSWORD_B64=$(printf ${ELASTIC_BOOTSTRAP_PASSWORD_PLAIN} | base64)
...
kustomize build test |
  envsubst '${PING_IDENTITY_DEVOPS_USER_BASE64}
    ...
    ${LOG_ARCHIVE_URL}
    ${EFS_FILESYSTEM_ID}
    ${ELASTIC_BOOTSTRAP_USER_B64}
    ${ELASTIC_BOOTSTRAP_PASSWORD_B64}
    ${ELASTIC_USER_B64}
