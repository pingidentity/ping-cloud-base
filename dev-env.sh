...
log "Initial ECR_REGISTRY_NAME: ${ECR_REGISTRY_NAME}"
log "Initial JFROG_REGISTRY_NAME: ${JFROG_REGISTRY_NAME}"

log "Initial PINGACCESS_PROFILE_IMAGE_TAG: ${PINGACCESS_PROFILE_IMAGE_TAG}"
log "Initial PINGFEDERATE_PROFILE_IMAGE_TAG: ${PINGFEDERATE_PROFILE_IMAGE_TAG}"
log "Initial PINGDIRECTORY_PROFILE_IMAGE_TAG: ${PINGDIRECTORY_PROFILE_IMAGE_TAG}"
log "Initial PINGDELEGATOR_PROFILE_IMAGE_TAG: ${PINGDELEGATOR_PROFILE_IMAGE_TAG}"
...
export ECR_REGISTRY_NAME="${PUBLIC_ECR_REGISTRY_NAME:-public.ecr.aws/r2h3l6e4}"
export JFROG_REGISTRY_NAME="${JFROG_REGISTRY_NAME:-pingcloud-virtual.jfrog.io}"

export PINGACCESS_PROFILE_IMAGE_TAG="${PINGACCESS_PROFILE_IMAGE_TAG}"
export PINGACCESS_WAS_PROFILE_IMAGE_TAG="${PINGACCESS_WAS_PROFILE_IMAGE_TAG}"
export PINGFEDERATE_PROFILE_IMAGE_TAG="${PINGFEDERATE_PROFILE_IMAGE_TAG}"
export PINGDIRECTORY_PROFILE_IMAGE_TAG="${PINGDIRECTORY_PROFILE_IMAGE_TAG}"
...
log "Using PINGACCESS_PROFILE_IMAGE_TAG: ${PINGACCESS_PROFILE_IMAGE_TAG}"
log "Using PINGFEDERATE_PROFILE_IMAGE_TAG: ${PINGFEDERATE_PROFILE_IMAGE_TAG}"
log "Using PINGDIRECTORY_PROFILE_IMAGE_TAG: ${PINGDIRECTORY_PROFILE_IMAGE_TAG}"
log "Using PINGDELEGATOR_PROFILE_IMAGE_TAG: ${PINGDELEGATOR_PROFILE_IMAGE_TAG}"

log "Using ECR_REGISTRY_NAME: ${ECR_REGISTRY_NAME}"
log "Using JFROG_REGISTRY_NAME: ${JFROG_REGISTRY_NAME}"
