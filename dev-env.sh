...
#                        |                                                    |
# CONFIG_REPO_BRANCH     | The branch within this repository for server       | v1.0.0-RC2-new-code-gen
...
export CONFIG_REPO_BRANCH="${CONFIG_REPO_BRANCH:-v1.0.0-RC2-new-code-gen}"
