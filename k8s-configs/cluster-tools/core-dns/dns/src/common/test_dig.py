...
class DigTests(unittest.TestCase):
    ...
    def test_get_k8s_domain_to_ip_mappings(self):
        ...
        self.assertEqual(secondary_ips, ['10.61.5.130', '10.61.9.16'], 'The secondary IP addresses did not match the expected values: ' + str(secondary_ips))
        ...
        self.assertEqual(tertiary_ips, ['10.61.4.131', '10.61.8.17'], 'The tertiary IP addresses did not match the expected values: ' + str(tertiary_ips))
