...
echo "testing JAVA_AGENT_OPTS profile-repo override"

# Set cursor limit agent
JAVA_AGENT_OPTS="${JAVA_AGENT_OPTS} -Dcom.unboundid.directory.server.backends.jeb.AttributeIndex.cursorEntryLimit=0"
