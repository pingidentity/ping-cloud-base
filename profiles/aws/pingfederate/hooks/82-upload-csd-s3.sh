...
alias collect-data="${SERVER_ROOT_DIR}/bin/collect-support-data.sh"
...
if ! test -z "${processed_filename}"; then
  ...
  beluga_log "Copying: ${src_file} to ${SKBN_CLOUD_PREFIX}/${src_file}"
  ...
  beluga_log "The file name is expected to be in the format: support-data-ping-pingfederate-0-20210125201530" "WARN"
