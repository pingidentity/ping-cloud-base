...
class TestP1SsoSetup(p1_test_base.P1TestBase):
    ...
    def test_configure_pa_was_redirect_uris_updated(self):
        ...
        new_oauth_pod_name = self.k8s.get_deployment_pod_name(
            self.oauth_service_label, self.ping_cloud_ns
        )
        self.assertTrue(new_oauth_pod_name != "", "New p14c-oauth-service pod not found after re-spinning.")
